...
*/
	...
	this.updateMovementModel = function ( delta ) {
		...
		var prevPos = this.root.position;
		if(!collision(this.root.position.x , this.root.position.y, this.root.position.z, initY)) {
			this.root.position.x += Math.sin( this.bodyOrientation ) * forwardDelta;
			this.root.position.z += Math.cos( this.bodyOrientation ) * forwardDelta;
			this.root.position.y = height(this.root.position.x, this.root.position.y,this.root.position.z, initY);
		} else {
			this.root.position.x -= Math.sin( this.bodyOrientation ) * forwardDelta;
			this.root.position.z -= Math.cos( this.bodyOrientation ) * forwardDelta;
		}
		...
		getRing(this.root.position.x,this.root.position.z);
	};
